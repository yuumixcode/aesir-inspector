...
3. 输入：`https://github.com/yuumixcode/AesirInspector.git?path=Assets/Runestone/AesirInspector`

### 通过 Assets 目录

将 `AesirInspector` 包文件夹放置到项目的 `Assets/` 目录下任意位置。

## 快速开始

安装后，通过菜单栏 `Tools → Aesir → Inspector` 访问主要功能：
