...
namespace RunLab.AesirInspector.OdinIntegration.Editor
{
    ...
    public class CodePreviewRenderer : IAttributeComponentRenderer
    {
        ...
        public void Reset()
        {
            ...
            if (_viewFullCodeIconTexture != null) UnityEngine.Object.DestroyImmediate(_viewFullCodeIconTexture);
            if (_viewShortenCodeIconTexture != null) UnityEngine.Object.DestroyImmediate(_viewShortenCodeIconTexture);
            if (_copyCodeIconTexture != null) UnityEngine.Object.DestroyImmediate(_copyCodeIconTexture);
        ...
        void DrawCodePreviewHeader(Rect headerToolBarRect)
        {
            ...
            if (_viewShortenCodeIconTexture == null)
                _viewShortenCodeIconTexture = SdfIcons.CreateTransparentIconTexture(SdfIconType.FullscreenExit,
                    Color.white, IconTextureSize, IconTextureSize, 0);

            if (_isShowShortenCodePreview)
            {
                if (GUI.Button(showSwitchButtonRect,
                        GUIHelper.TempContent(" " + _viewFullCodeButtonLabel, _viewFullCodeIconTexture),
            ...
            {
                if (GUI.Button(showSwitchButtonRect,
                        GUIHelper.TempContent(" " + _viewShortenCodeButtonLabel, _viewShortenCodeIconTexture),
                        SirenixGUIStyles.ToolbarButton))
                {
                    _isShowShortenCodePreview = true;
                }
            ...
            if (_copyCodeIconTexture == null)
                _copyCodeIconTexture = SdfIcons.CreateTransparentIconTexture(SdfIconType.Stack,
                    Color.white, IconTextureSize, IconTextureSize, 0);
            if (GUI.Button(copyButtonRect, GUIHelper.TempContent(" " + _copyCodeButtonLabel, _copyCodeIconTexture),
                    SirenixGUIStyles.ToolbarButton))
            {
