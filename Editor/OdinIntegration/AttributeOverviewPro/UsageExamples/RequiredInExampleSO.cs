...
namespace RunLab.AesirInspector.OdinIntegration.Editor
{
    ...
    {
        [Title("Note")]
        [DisplayAsString(fontSize: 12)]
        [HideLabel]
        public string info = "RequiredIn attribute is specific to prefabs. It will only show validation errors when the object is a certain kind of prefab (e.g., Asset, Instance in Scene, etc.).";
