...
{
    [FilePath(
        ProjectFilePath + "/RuntimeInitializeLoadType/LoadTypeSettings.asset",
    ...
    public class RuntimeInitializeLoadTypeSettings : ScriptableSingleton<RuntimeInitializeLoadTypeSettings>
    {
        ...
        [LabelWidth(300)]
        [ShowInInspector]
        [BilingualText("Sample 执行在 AfterSceneLoad 时机的方法",
            "Sample method executed at AfterSceneLoad timing")]
        ...
        [PropertySpace]
        [BilingualButton("启用所有时机的执行选项", "Enable All Execution Options", ButtonSizes.Medium)]
        ...
        [PropertySpace]
        [BilingualButton("禁用所有时机的执行选项", "Disable All Execution Options", ButtonSizes.Medium)]
